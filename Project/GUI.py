...
def print_simulation_results(simulation_result):
    print(f"""\n\n{'-' * 50}\nEnd of Simulation Report
            Number of open centres: {simulation_result["Open Centres"]}
            Number of full centres: {simulation_result["Full Centres"]}
            Number of trainees in training: {simulation_result['Trainees Training']}
            Number of trainees in waiting : {simulation_result['Trainees Waiting']}
